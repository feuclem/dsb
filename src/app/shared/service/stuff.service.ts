...
export class StuffService {
  ...
  _slot4 = new BehaviorSubject<StuffViewModel>(undefined)
  _slot5 = new BehaviorSubject<StuffViewModel>(undefined)
  _slot6 = new BehaviorSubject<StuffViewModel>(undefined)
